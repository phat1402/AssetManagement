var TableDatatablesColreorder = function () {
    ...
    var initTable1 = function () {
        var table = $('#asset_by_employee_table');
...
function filterAssetByEmployee() {
    var employeeId = $('.select-employee').select2('val');
    $.ajax({
        async: false,
        url: '/Home/FilterAssetByEmployee',
        data: { employeeId: employeeId },
        success: function (response) {
            $("#assetByEmployeeTable").html(response);
