    ...
    var handleTable = function () {
        ...
        function saveRow(oTable, nRow) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "/Home/CreateOrUpdateEmployee",
            ...
            $('#employee-list-table_new').prop("disabled", false);
        }
        ...
        var tableWrapper = $("#employee-list-table_wrapper");
        ...
        $('#employee-list-table_new').click(function (e) {
            ...
            nEditing = nRow;
            nNew = true;
            $('#employee-list-table_new').prop("disabled", true);
        });
