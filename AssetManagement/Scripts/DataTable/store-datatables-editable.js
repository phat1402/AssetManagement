var TableDatatablesEditable = function () {
    ...
    var handleTable = function () {
        ...
        function saveRow(oTable, nRow) {
            ...
            storeID = $(nRow).data("id");
            name = jqInputs[0].value;
            $.ajax({
                url: "/Home/CreateOrUpdateStore",
                type: "POST",
                data: {
                    ID: storeID,
                    Name: name,
            ...
            $('#store-list-table_new').prop("disabled", false);
        }
        ...
        var tableWrapper = $("#store-list-table_wrapper");

        var nEditing = null;
        var nNew = false;

        $('#store-list-table_new').click(function (e) {
            e.preventDefault();
            ...
            nEditing = nRow;
            nNew = true;
            $('#store-list-table_new').prop("disabled", true);
        });
