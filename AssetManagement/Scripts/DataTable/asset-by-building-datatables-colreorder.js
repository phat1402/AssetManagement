var TableDatatablesColreorder = function () {
    ...
    var initTable1 = function () {
        var table = $('#asset_by_building_table');
...
function filterAssetByBuilding() {
    var buildingName= $('.select-building').select2('data')[0].text;
    $.ajax({
        async: false,
        url: '/Home/FilterAssetByBuilding',
        data: { buildingName: buildingName },
        success: function (response) {
            $("#assetByBuildingTable").html(response);
