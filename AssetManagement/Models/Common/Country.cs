...
namespace AssetManagement.Models.Common
{
    public class Country
    {
        public static List<SelectListItem> CountryList = new List<SelectListItem> {
            ...
            new SelectListItem() { Text="Central African Rep",Value="Central African Rep"},
            ...
            new SelectListItem() { Text="Congo {Democratic Rep}",Value="Congo {Democratic Rep}"},
            ...
            new SelectListItem() { Text="Saint Vincent & the Grenadines",Value="Saint Vincent & the Grenadines"},
